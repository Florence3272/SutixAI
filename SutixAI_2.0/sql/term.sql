...
CREATE TABLE `term`  (
  ...
  `en_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '英文术语',
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '术语表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of term
-- ----------------------------
INSERT INTO `term` VALUES (1, '国际贸易', NULL, 'Международная торговля', '跨越国境的商品与服务交换活动，是经济全球化重要组成部分。', 10, 2, '2026-05-25 12:55:38', NULL);
INSERT INTO `term` VALUES (2, '人工智能', NULL, 'Искусственный интеллект', '使机器模拟人类感知、推理、学习与决策的技术科学。', 5, 2, '2026-05-25 18:48:09', NULL);
INSERT INTO `term` VALUES (3, '生态环境', NULL, 'Экологическая среда', '生物群落与周边自然因素相互作用形成的整体生态系统。', 12, 2, '2026-05-25 18:48:51', NULL);
INSERT INTO `term` VALUES (4, '智能制造', NULL, 'Умное производство', '依托物联网、大数据与自动化实现工厂智能化生产模式。', 1, 2, '2026-05-25 18:49:35', NULL);
